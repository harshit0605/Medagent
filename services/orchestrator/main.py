...
# ---- Post-op recovery checklist (task #13) ----------------------------------
...
@app.post("/patients/{patient_id}/post-op", response_model=PostOpEpisodeDTO)
...
@app.get("/patients/{patient_id}/post-op", response_model=PostOpEpisodeDTO)
...
# ---- Multi-patient households (task #13) -------------------------------------
...
@app.post("/households", response_model=HouseholdDTO)
...
@app.get("/households/{household_id}", response_model=HouseholdDTO)
...
@app.get("/patients/{patient_id}/household", response_model=HouseholdDTO)
